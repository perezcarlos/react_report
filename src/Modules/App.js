...
class App extends Component {
    ...
    onSelect(buildSelection) {
        ...
        this.setState ({
            ...
            const view = this.props.location.query.filter || 'list';
            const path = `/suite/${this.state.buildSelection.selectedSuite}/build/${this.state.buildSelection.selectedBuild}?filter=${filter}&view${view}`;
